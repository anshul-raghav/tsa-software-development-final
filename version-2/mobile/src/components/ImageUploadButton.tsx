/**
 * REMOVABLE: This entire file can be deleted to remove upload support.
 *
 * Self-contained image upload button using expo-image-picker.
 * Lets the user pick an image from their device library as an
 * alternative to the live camera capture.
 */
