"""
System prompt and schema for OpenAI Vision panelmap extraction: instructs the model to return strict JSON
describing controls, regions, landmarks, and global_description from a panel image and OCR context.
"""
PANELMAP_SCHEMA = """{
