"""
In-memory session store for scan records and task plans keyed by scan_id.

Used by routes and the scan pipeline. In production would be replaced by a DB-backed store.
"""
...
from app.domain.models.task_models import TaskPlan
from app.domain.schemas.scan_schemas import OCRResult, ScanDetailResponse
