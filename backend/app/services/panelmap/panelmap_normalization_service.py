"""
Validates and normalizes PanelMap data: deduplicate controls, normalize labels, fill aliases,
identify primary actions, infer control types, and compute scan confidence.
"""
from __future__ import annotations

from app.core.logging import logger
from app.core.exceptions import PanelMapValidationError
from app.domain.models.panel_map_models import PanelMap, ControlNode, ControlType
