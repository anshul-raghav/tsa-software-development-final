"""
Domain exceptions and mapping to HTTP status codes.

All TouchMap domain errors inherit from TouchMapError; touchmap_exception_to_http
converts them to FastAPI HTTPException for consistent API responses.
"""
